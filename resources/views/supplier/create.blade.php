        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-12">
                        <form action="{{ URL::route('supplier.save') }}" method="post" class="row g-3">
                            @csrf
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputPassword4" name="contact_person" required>
                            </div>
                            <div class="col-4">
                                <label for="inputAddress" class="form-label">Category</label>
                                <input type="text" class="form-control" id="inputAddress" name="category" required>
                            </div>
                            <div class="col-12">
